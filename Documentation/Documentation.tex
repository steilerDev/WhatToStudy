...
The best error rate arrived at 14\% for cours and 6\% for final grade. Appendix \vref{app:Network} shows our final Bayesian network. Based on this network the recommendations are given.
