...
public class TestNet {
  ...
  public static void main(String[] args) {
    ...
    try {
      ...
      System.out.println ("      Error rate for " + cancer.getName() + " = " + tester.getErrorRate (cancer));
      System.out.println ("Logarithmic loss for " + cancer.getName() + " = " + tester.getLogLoss (cancer));
